...
export default class ExRenderFilm extends Component {
  renderFilm = () => {
        ...
        <div className="col-3 mt-2" key={index}>
          <div className="card">
            ...
            <div className="card-body bg-dark text-white">
              <h3 style={{ height: 75 }}>{item.tenPhim}</h3>
              <p>
  ...
  render() {
    return (
      <div
        style={{
          background: "url(./img/avanger.jpg)",
      ...
      >
        ...
        >
          ...
          <div className="row mt-2">{this.renderFilm()}</div>
        </div>
      </div>
    );
  }
